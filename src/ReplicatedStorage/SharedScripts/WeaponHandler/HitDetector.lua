...
function HitDetector:fire(origin, initialVelocity, acceleration, maxDist, filterType, filterObjects, bulletPart)
	local timePassed = 0
...
function HitDetector:renderBullet(bulletPart)
...
function HitDetector:destroyBullet(bulletPart)
	if bulletPart then
